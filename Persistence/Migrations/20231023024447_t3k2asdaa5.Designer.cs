...
namespace Persistence.Migrations
{
    ...
    [Migration("20231023024447_t3k2asdaa5")]
    partial class t3k2asdaa5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrototypeBackend.Entities.GenderEntity", b =>
                {
            ...
            modelBuilder.Entity("PrototypeBackend.Entities.ProfileEntity", b =>
                {
                    ...
                    b.Property<Gender>("PreferredGender")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<int>("helloGenderIdentityId")
                        .HasColumnType("integer");

                    b.HasKey("ProfileId");

                    b.HasIndex("helloGenderIdentityId");
            ...
            modelBuilder.Entity("PrototypeBackend.Entities.ProfileEntity", b =>
                {
                    ...
                    b.HasOne("PrototypeBackend.Entities.GenderEntity", "hello")
                        .WithMany()
                        .HasForeignKey("helloGenderIdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
